...
const Hero = () => {
  return (
    ...
    >
      ...
      <div className=" flex flex-col py-8 mx-auto bg-zinc-200 border border-slate-300 rounded-xl text-center shadow-xl md:w-[50%] md:absolute md:bottom-[-30px] md:left-[25%]">
        <p className="pb-4">Data Services</p>
        <div className="flex justify-between flex-wrap px-4">
          ...
          <p className="flex px-4 py-2 text-slate-500 mr-[105px] md:mr-0">
