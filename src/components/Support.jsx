...
const Support = () => {
  return (
    <div name="support" className="w-full mt-24">
      {/* Hero Image, fondo gray y la foto */}
      ...
      <div className="max-w-[1240px] mx-auto text-white relative">
        ...
        {/* el gap-y-16 es para mobile y el gap-x-8 es para desktop */}
        <div className="grid grid-cols-1 lg:grid-cols-3 relative gap-x-8 gap-y-16 px-4 pt-12 sm:pt-20 text-black mt-10">
